...
const Page2 = () => {
    ...
    return (
        <div id='section2' className='bg-white text-center p-28 text-black'>
            <h3 className='text-gray-500 text-4xl font-[anzo2]'>©  anzo.studio 2025 | designed and developed</h3>
            <div className='rotateText mt-40'>
                <h1 className='text-[42vw] text-black font-[anzo3] leading-[35vw]'>IMPACTFUL</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[42vw] text-black font-[anzo3] leading-[35vw]'>DESIGN</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[42vw] text-black font-[anzo3] leading-[35vw]'>IS THE</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[42vw] text-black font-[anzo3] leading-[35vw]'>DESIGN</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[42vw] text-black font-[anzo3] leading-[35vw]'>THAT</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[42vw] text-black font-[anzo3] leading-[35vw]'>WORKS</h1>
            </div>
                    ...
                    <g>
                        ...
                        <g clipPath="url(#96a8edfe-3cce-4a8a-8fa1-014070af92c2_comp-lmyox36t2)">
                            ...
                            <g filter="url(#051c9507-4be0-407a-81f9-24a005c00fd5_comp-lmyox36t2)">
                                <path fill="#060606" d="M705.812 5.987c0-.545.441-.987.987-.987h70.082c.545 0 .987.442.987.987V76.07a.987.987 0 0 1-.987.987h-70.082a.987.987 0 0 1-.987-.987V5.987Zm36.028 9.826c-13.929 0-25.22 11.292-25.22 25.22 0 13.929 11.291 25.22 25.22 25.22 13.928 0 25.22-11.291 25.22-25.22 0-13.928-11.292-25.22-25.22-25.22Z" clipRule="evenodd" fillule="evenodd"></path>
                            </g>
                        </g>
                        <defs fill="none">
            ...
            <div className='h-1 w-1/3 relative left-1/2 -translate-x-1/2 mt-40 bg-black'></div>
