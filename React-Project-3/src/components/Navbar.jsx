...
const Navbar = () => {
  ...
  return (
    <motion.div
      className="fixed top-0 z-[999] bg-zinc-900/80 w-full px-20 py-8 font-[ochi4] flex justify-between items-center backdrop-blur-md"
    ...
    >
      ...
      <div className="links flex gap-10">
        {["Services", "Our work", "About us", "Insights", "Contact us"].map(
          (item, index) => (
            <a key={index} className={`text-xl font-light ${index === 4 && "ml-32"}`}>
              {item}
            </a>
          )
        )}
