...
function Footer() {
  ...
  return (
    <motion.div
      ...
      className="w-full h-screen p-20 relative flex flex-col justify-between bg-black text-white"
      initial = {{y: 150}}
      animate = {{y:0}}
      transition={{ease: [0.45, 0, 0.55, 1], duration: 10}}
    >
      <div className="flex justify-between w-full">
        <div>
          <h1 className="text-[6vw] font-bold tracking-tight leading-[0.85]">
            EYE-<br />
            <span className="-mt-4 inline-block">OPENING</span>
          </h1>
        </div>

        <div className="relative">
          <h1 className="text-[6vw] font-bold tracking-tight leading-none">
            PRESENTATIONS
          </h1>
          <div className="absolute left-2 pt-20 flex flex-col items-start">
            <h2 className="text-xl font-bold">S:</h2>
            <div className="mt-2">
              <a href="https://www.facebook.com" target="_blank" className="text-white underline hover:underline block mb-2">Facebook</a>
              <a href="https://www.linkedin.com" target="_blank" className="text-white underline hover:underline block mb-2">LinkedIn</a>
              <a href="https://www.instagram.com" target="_blank" className="text-white underline hover:underline block">Instagram</a>
            </div>
          </div>
        </div>
        ...
        <svg width="75" height="40" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
